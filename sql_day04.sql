...
/*
 WHERE 조건에 있는 e.SAL 은 1행을 비교하기 위한 값인데
...
-- 1) 기본 값 설정전에 멤버 정보 하나 추가 : address 가 NULL 인 데이터
INSERT INTO "SCOTT"."OJUNG_MEMBER" (MEMBER_ID, MEMBER_NAME, PHONE, BIRTH_MONTH, GENDER) 
...
;  
/*
SYS_C007029	C	MAIN_TABLE
SYS_C007030	P	MAIN_TABLE
SYS_C007031	U	MAIN_TABLE
SYS_C007032	C	SUB_TABLE
SYS_C007033	R	SUB_TABLE
*/
...
;  
/*
CK_MAIN_TABLE_GENDER	C	MAIN_TABLE
PK_MAIN_TABLE	        P	MAIN_TABLE
UQ_MAIN_TABLE_NICK	    U	MAIN_TABLE
SYS_C007037	            C	SUB_TABLE
FK_SUB_TABLE	        R	SUB_TABLE
*/
...
(  id       VARCHAR2(10) 
 ...
 -- 복합키로 PK 를 설정할때는 제약조건을 따로 설정하는 방법으로만 가능
);
...
/*
PK_MAIN_TABLE4	        P	MAIN_TABLE
UQ_MAIN_TABLE_NICK4	    U	MAIN_TABLE
CK_MAIN_TABLE_GENDER4	C	MAIN_TABLE
SYS_C007048	            C	SUB_TABLE
PK_SUB_TABLE4       	P	SUB_TABLE
FK_SUB_TABLE4	        R	SUB_TABLE
*/
...
SELECT u.CONSTRAINT_NAME
 ...
 WHERE u.TABLE_NAME IN ('MAIN_TABLE', 'SUB_TABLE')  
; 
/* -- sub_table 에 생성되어 있던 R 이 같이 제거되었음을 확인
------------------------------------------------------------
SYS_C007048	    C	SUB_TABLE
PK_SUB_TABLE4	P	SUB_TABLE
*/
